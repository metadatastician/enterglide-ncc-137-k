...
#
# Enterglide NCC-137-K — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: enterglide-ncc-137-k-release)
