...
# Enterglide NCC-137-K container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping enterglide-ncc-137-k..."
...
echo "Starting enterglide-ncc-137-k..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/enterglide-ncc-137-k
#   exec /app/release/bin/enterglide-ncc-137-k start
#   exec /app/enterglide-ncc-137-k serve --host "${APP_HOST}" --port "${APP_PORT}"
