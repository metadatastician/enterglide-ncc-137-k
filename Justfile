...
project := "enterglide-ncc-137-k"
OWNER := "metadatastician"
REPO := "enterglide-ncc-137-k"
version := "0.1.0"
...
info:
    @echo "Project: enterglide_ncc_137_k"
...
build *args:
    @echo "Building enterglide_ncc_137_k (debug)..."
...
build-release *args:
    @echo "Building enterglide_ncc_137_k (release)..."
...
test *args:
    #!/usr/bin/env bash
    # Reserved repo: no implementation yet. The real gates are the placeholder
    # and root-shape checks. Replace this body when code lands.
    set -euo pipefail
...
install: build-release
    @echo "Installing enterglide_ncc_137_k..."
...
cookbook:
    ...
    echo "= enterglide_ncc_137_k Justfile Cookbook" > "$OUTPUT"
...
man:
    #!/usr/bin/env bash
    mkdir -p docs/man
    cat > docs/man/enterglide_ncc_137_k.1 << EOF
    .TH enterglide_ncc_137_k 1 "$(date +%Y-%m-%d)" "{{version}}" "enterglide_ncc_137_k Manual"
    .SH NAME
    enterglide_ncc_137_k \- RSR-compliant project
    .SH SYNOPSIS
    .B just
    [recipe] [args...]
    .SH DESCRIPTION
    ...
    EOF
    echo "Generated: docs/man/enterglide_ncc_137_k.1"
...
doctor:
    @echo "Running diagnostics for enterglide-ncc-137-k..."
...
tour:
    @echo "=== enterglide-ncc-137-k Tour ==="
    @echo ""
...
help-me:
    @echo "=== enterglide-ncc-137-k Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/metadatastician/enterglide-ncc-137-k/issues/new"
    @echo ""
