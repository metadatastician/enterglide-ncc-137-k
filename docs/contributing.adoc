...
= Contributing — Enterglide NCC-137-K
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Enterglide NCC-137-K`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/Enterglide NCC-137-K.git
...
* Bugs in `Enterglide NCC-137-K`: file at `metadatastician/Enterglide NCC-137-K/issues`.
