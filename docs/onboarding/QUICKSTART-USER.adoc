...
// Replace enterglide-ncc-137-k, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= enterglide-ncc-137-k — Quick Start for Users
:toc:
:toclevels: 2

== What is enterglide-ncc-137-k?
...
[source,bash]
----
just install --portable --prefix=./enterglide-ncc-137-k-portable
----
...
* **Wiki**: https://github.com/metadatastician/enterglide-ncc-137-k/wiki
